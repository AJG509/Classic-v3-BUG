...
//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'ꪶ༺𖤓⃞⃝💚༒𝗦𝗲𝗻𝗸𝘂 𝗜𝘀𝗵𝗶𝗴𝗮𝗺𝗶༒𖤓⃞🗿֎⸙༻' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
global.owner = ['16132197256'] // ubah aja pake nomor lu
//==========================zetsuboclient=======================//
...
global.author = '༻𖤓⃞⃝💚༒𝗦𝗲𝗻𝗸𝘂 𝗜𝘀𝗵𝗶𝗴𝗮𝗺𝗶༒𖤓⃞🗿༺' // ubah aja ini nama sticker
global.prefa = ['','!','.',',','🐤','🗿']
